  ...
  return (
    <div className="flex items-center gap-3">
      ...
      >
        ...
        <span>{isMetronomeOn ? "Parar" : "Metronomo"}</span>
      </button>
      ...
      <div className="flex items-center gap-1.5">
        <button
          ...
          className="w-10 h-10 flex items-center justify-center rounded-lg bg-bg-tertiary text-text-secondary hover:text-text-primary text-sm cursor-pointer border border-border-default"
        >
          -
        </button>
        <span className="text-xs font-mono text-text-secondary w-14 text-center">
          {bpm} bpm
        </span>
        <button
